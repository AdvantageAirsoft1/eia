...
// Images and Icons
import logo from "@/public/EIALogo_small.png";
    ...
    return (
        <nav className={`py-4 w-full ${isScrolling ? "fixed top-0 bg-white shadow-lg z-10" : "relative"}`}>
            <div className="w-[89%] m-auto flex justify-between items-center  max-w-[1400px]">
                <a href="/">
                    <Image src={logo} width={250} height={150} alt="EIA Logo" />
                </a>

                <ul
                    className={`md:flex items-center gap-8 md:static absolute text-black  ${openMobileMenu
                ...
                >
                    ...
                    <li>
                        <a href="#Events" onClick={() => setOpenMobileMenu(false)}>
                            Events
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#rules" onClick={() => setOpenMobileMenu(false)}>
                            EIA Rules
                        </a>
                    </li>
                    <li>
